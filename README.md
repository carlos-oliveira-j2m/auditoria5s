...
/* Plano de Fundo Dinâmico Original */
body { 
    ...
    <div class="no-print">
        <div class="filter-bar">
            ...
            <div style="display:flex; align-items:flex-end; gap:5px;">
                <button class="btn-secondary" style="width:auto" onclick="resetForm()">Novo</button>
                <button style="background:#10b981; width:auto" class="btn" onclick="window.print()">Salvar PDF</button>
            </div>
        </div>
    </div>
...
const imagensFundo = [
    ...
    "https://images.unsplash.com/photo-1592982537447-6f2a6a0c3c8b?auto=format&fit=crop&q=80&w=1920"
];
let imgIndex = 0;
function mudarFundo() {
...
const checklist = [
    ...
    { s: "Limpeza", p: ["Máquinas limpas?", "Ausência de vazamentos?", "Equipamentos OK?", "Coleta seletiva?", "Áreas comuns limpas?"] },
    { s: "Padronização", p: ["Padrão visual seguido?", "Identificação correta?", "Lixeiras no local?", "EPIs em uso?"] },
...
function salvarSenso() {
    ...
    audit.respostas[sensoIndex] = { media: media, plano: document.getElementById('txtPlano').value };
